...
class Juego_Generala:
    def __init__(self):
        self.__generala__ = Generala()
    ...
    def planilla(self):
        # Implementar una estructura de Dataframe, utilizando a los jugadores y 
        # los valores de sus jugadas como los datos del dataframe.
        pass